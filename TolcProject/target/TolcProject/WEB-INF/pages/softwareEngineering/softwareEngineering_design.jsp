...
There are multiple variants of software design.</p>
...
<h1>Function-Oriented Design</h1>
...
<div class="pre-btn">
<a href="http://localhost:7080/TolcProject/softwareEngineering?id=${employee.id}"><i class="icon icon-arrow-circle-o-left big-font"></i> Previous Page</a>
</div>

<div class="nxt-btn">
<a href="http://localhost:7080/TolcProject/softwareEngineering/projectManagement?id=${employee.id}">Next Page <i class="icon icon-arrow-circle-o-right big-font"></i>&nbsp;</a>
</div>
