...
<head>
<meta charset="utf-8">
<title>Classification Tutorial</title>
...
<script type="text/javascript" src="https://www.tutorialsdpoint.com/theme/js/script-min-v4.js"></script>
...
<aside class="sidebar">
<div class="mini-logo">
<img src="https://image.ibb.co/iKMO5m/machine_learning.jpg" alt="Machine Learning" />
</div>


<ul class="nav nav-list primary left-menu">
<li class="heading">Machine Learning</li>   
...
<div class="cover">
<img class="img-responsive" src="https://image.ibb.co/iKMO5m/machine_learning.jpg" alt="Data Structures & Algorithms (DSA) Tutorial" />
</div>
<hr />
...
<p>Classification is a machine learning technique that uses known data to determine how the new data should be classified into a set of existing categories. </p>
<h1>How can classification works</h1>
<p>While classifying a given set of data, the classifier system performs the following actions:Initially a new data model is prepared using any of the learning algorithms.Then the prepared data model is tested. Thereafter, this data model is used to evaluate the new data and to determine its class.</p>
<h1>Naive Bayes Classifier</h1>
<p>Naive Bayes is a simple technique for constructing classifiers. It is not a single algorithm for training such classifiers, but a family of algorithms. A Bayes classifier constructs models to classify problem instances. These classifications are made using the available data.</p>
...
<div class="pre-btn">
<a href="http://localhost:7080/TolcProject/machineLearning?id=${employee.id}"><i class="icon icon-arrow-circle-o-left big-font"></i> Previous Page</a>
</div>

<div class="nxt-btn">
<a href="http://localhost:7080/TolcProject/machineLearning/clustering?id=${employee.id}">Next Page <i class="icon icon-arrow-circle-o-right big-font"></i>&nbsp;</a>
</div>
