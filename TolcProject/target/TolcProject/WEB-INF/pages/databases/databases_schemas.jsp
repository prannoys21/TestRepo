...
<form:form action="../sendNotification?id=${employee.id}" method="post" modelAttribute="ticker" name="notificationAddition" id="notificationAddition"> 
					...
					<input type="hidden" name="courseName" path="courseLevel" value="4" />
...
<div class="pre-btn">
<a href="http://localhost:7080/TolcProject/databases/databases_models?id=${employee.id}"><i class="icon icon-arrow-circle-o-left big-font"></i> Previous Page</a>
</div>
