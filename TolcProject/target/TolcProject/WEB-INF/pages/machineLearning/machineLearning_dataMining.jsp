...
<head>
<meta charset="utf-8">
<title>Data Mining Tutorial</title>
...
<div class="pre-btn">
<a href="http://localhost:7080/TolcProject/machineLearning/clustering?id=${employee.id}"><i class="icon icon-arrow-circle-o-left big-font"></i> Previous Page</a>
</div>
