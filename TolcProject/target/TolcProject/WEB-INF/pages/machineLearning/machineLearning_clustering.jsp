...
<head>
<meta charset="utf-8">
<title>Clustering Tutorial</title>
...
<p>Clustering is the procedure to organize elements or items of a given collection into groups based on the similarity between the items. For example, the applications related to online news publishing group their news articles using clustering.</p>
<h1>Applications of Clustering</h1>
<p>Clustering is broadly used in many applications such as market research, pattern recognition, data analysis, and image processing.
...
Clustering helps in identification of areas of similar land use in an earth observation database.</p>
...
<div class="pre-btn">
<a href="http://localhost:7080/TolcProject/machineLearning/classification?id=${employee.id}"><i class="icon icon-arrow-circle-o-left big-font"></i> Previous Page</a>
</div>
<div class="nxt-btn">
<a href="http://localhost:7080/TolcProject/machineLearning/dataMining?id=${employee.id}">Next Page <i class="icon icon-arrow-circle-o-right big-font"></i>&nbsp;</a>
</div>
