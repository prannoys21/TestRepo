	...
	<section class="testimonial" style="background-image: url(https://novoed.com/wp-content/uploads/2016/10/Transformation-Cropped.jpg);">
		<div class="container">
				...
				<div class="col-md-8 col-md-offset-2">
										<div class="text">
						"welearn is changing the way students interact and collaborate in an online learning community"</div>
										<div class="author">
												<div class="photo">
							<img src="https://image.ibb.co/crfRbG/ggoeldp.jpg" alt="Prannoy" />
						</div>
																		<div class="name">Prannoy Chandra</div>
																		<div class="info">Graduate Research Assistant<br/>Masters student pursuing Computer Science at Arizona State University</div>
											</div>
				</div>
			</div>
		</div>
