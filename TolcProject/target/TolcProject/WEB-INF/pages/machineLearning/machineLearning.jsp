...
<p>Machine learning is a branch of science that deals with programming the systems in such a way that they automatically learn and improve with experience.</p>
<h1>Audience</h1>
<p>This tutorial has been prepared for the computer science graduates to help them understand the basic to advanced concepts related to Machine Learning.</p>
<h1>Prerequisites</h1>
...
<div class="nxt-btn">
<a href="http://localhost:7080/TolcProject/machineLearning/classification?id=${employee.id}">Next Page <i class="icon icon-arrow-circle-o-right big-font"></i>&nbsp;</a>
</div>
